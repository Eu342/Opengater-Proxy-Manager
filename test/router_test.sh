...
assert_eq "GET geo"          "get_geo"              "$(route_request GET  /v1/geo)"
assert_eq "GET geo groups"   "get_geo_groups"       "$(route_request GET  /v1/geo/groups)"
assert_eq "PUT geo active"   "put_geo_active"       "$(route_request PUT  /v1/geo/active)"
...
assert_eq "POST routing apply" "post_routing_apply" "$(route_request POST /v1/routing/apply)"
